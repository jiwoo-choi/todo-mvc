export default class ViewController {
    ...
    addJotaiSubListener(store, atom, listener) {
        this._internalJotaiListener.push(store.sub(atom, listener))
    }
    ...
    _removeAddedListenerAll() {
        ...
        this._internalJotaiListener.forEach((value) => {
            value();
        })
        this._internalJotaiListener = [];
        this._internalListener = [];
